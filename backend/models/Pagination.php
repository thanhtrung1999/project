...
//Sau khi có được 2 thông số trên là total và limit, cần xác định số trang sẽ được chia ra dựa vào phép chia total/limit, đây là phép chia nên có thể sẽ xuất hiện số thập phân, do đó cần làm tròn lên bằng hàm ceil của php
