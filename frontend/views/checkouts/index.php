            ...
            <div class="row checkout__content__main">
                ...
                <div class="col-md-5 cart-info">
                            ...
                            <?php foreach($_SESSION['cart'] AS $product_id => $product): ?>
                                <?php if(!empty($product_variants[$product_id])):?>
                                    <?php foreach ($product as $variant_id => $item):?>
                                        <div class="col-12 cart-info__detail-main">
                                            <div class="row">
                                                <div class="col-8 product-info">
                                                    <div class="row">
                                                        <div class="col-4 p-0 product-info__image">
                                                        ...
                                                        ?>
                                                        <div class="col-8 product-info__title">
                                                            <p><?= $item['name']?></p>
                    ...
                    <div class="row cart-info__total">
                        <div class="col-6 cart-total__labels">
                            <span>Tổng đơn hàng</span>
                        </div>
                        <div class="col-6 cart-total__content">
